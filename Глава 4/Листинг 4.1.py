...
image.save("img-with-logo/star_image.png")  # Сохраняем изображение звезды в указанной папке с заданным именем.
...
myqr.run(  # Запускаем генерацию QR-кода.
    ...
    picture="img-with-logo/star_image.png",  # Изображение звезды, добавляемое в QR-код.
