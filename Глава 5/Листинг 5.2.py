...
# Определяем координаты для глаз
...
smiley_image.save("img/smile.png")  # Сохраняем итоговое изображение смайлика в файл
...
combined_image.save("qr/qr_smile_with_bg.png")  # Сохраняем итоговое изображение с QR-кодом и смайлом в файл