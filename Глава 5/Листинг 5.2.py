...
# Генерируем QR-код
qr_save_path = "../Глава 4/qr_code.png"  # Путь для сохранения сгенерированного QR-кода
amzqr.run(
...
combined_image.save("rounded_qr_code_with_translucent_smiley_background.png")  # Сохраняем итоговое изображение в файл
combined_image.show()  # Отображаем итоговое изображение на экране
